package evertday.practice.teacher;
...
public class Flink05_WordCount_OnTimer_SideOutPut_State_JdbcSink {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //4.将主流输出到MySQL
        result.addSink(new MyJdbcSink("INSERT INTO mainOut(id,ct) VALUES(?,?) ON DUPLICATE KEY UPDATE ct=?;", 3));

        //5.获取侧输出流数据输出到MySQL
        result.getSideOutput(new OutputTag<String>("SideOutPut") {
        }).addSink(new MyJdbcSink("INSERT INTO Error(str) VALUES(?)", 1));
