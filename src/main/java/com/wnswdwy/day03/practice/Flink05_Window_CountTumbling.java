...
import com.wnswdwy.day01.Flink02_WordCount_Bounded;
...
public class Flink05_Window_CountTumbling {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //3.压平
        SingleOutputStreamOperator<Tuple2<String, Integer>> wordToOne = socketTextStream.flatMap(new Flink02_WordCount_Bounded.MyFlatMapFunc());
